...
function onCookiePolicyModalClose(isStatisticsCookiesAllowed: any) {
...
<template>
  <div>
    <div class="u-max-page-width" style="position: relative">
      <a
        aria-label="Instagram"
        href="https://www.instagram.com/loosen_schausteller/"
        target="_blank"
        rel="noopener"
        class="header-button header-button__instagram"
      >
        <svg
          width="48"
          height="48"
        ...
        >
          <rect width="504" height="504" fill="url(#pattern0)" />
          <defs>
      ...
      <button
        ...
        class="header-button header-button__menu"
        type="button"
    ...
    <div class="layout">
      <header class="header">
        <nuxt-link class="header__link" to="/">
          <img class="header__logo" alt="Logo Loosen" src="@/assets/logo-loosen.png" />
          <p class="header__subtitle">seit 1863</p>
        </nuxt-link>
      </header>
      <div>
...
.header-button {
  ...
  svg {
    fill: variables.$font-color-default;
  }
...
.nav {
  ...
  &__link {
    display: block;
    padding: variables.$space-s variables.$space-s variables.$space-s - variables.$tabs-border-bottom-width
      variables.$space-s;

    color: variables.$font-color-default;
    border-bottom: variables.$tabs-border-bottom-width solid transparent;

    &:hover {
      color: variables.$font-color-light;
      border-color: variables.$tabs-border-bottom-color-hover;
    }
    ...
    &--active {
      color: variables.$primary-color;
      border-color: variables.$tabs-border-bottom-color-selected;
    }
  }
}
...
@media (max-width: variables.$max-width-mobile-landscape) {
  ...
  .header-button {
    ...
    &__instagram {
      right: 2 * variables.$space-s + variables.$space-l;

      svg {
        width: variables.$size-l;
        height: variables.$size-l;
      }
    }
